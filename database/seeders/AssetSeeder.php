...
class AssetSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $sampleAssets = [
            ...
            [
                'nama_aset' => 'Komputer Riba Asus ZenBook',
                'jenis_aset' => 'Elektronik',
                'kategori_aset' => 'asset',
                'tarikh_perolehan' => '2022-01-10',
                'kaedah_perolehan' => 'Pembelian',
                'nilai_perolehan' => 3500.00,
                'diskaun' => 500.00,
                'umur_faedah_tahunan' => 4,
                'pembekal' => 'Asus Malaysia',
                'jenama' => 'Asus',
                'tempoh_jaminan' => '2 tahun',
                'tarikh_tamat_jaminan' => '2024-01-10',
                'status_aset' => 'Sedang Digunakan',
                'keadaan_fizikal' => 'Baik',
                'status_jaminan' => 'Tamat',
                'catatan' => 'Laptop untuk kerja pentadbiran',
                'lokasi_penempatan' => 'Bilik Setiausaha',
                'pegawai_bertanggungjawab_lokasi' => 'Ahmad bin Abdullah',
                'jawatan_pegawai' => 'Setiausaha',
            ],
            [
                'nama_aset' => 'Mesin Cuci LG 8kg',
                'jenis_aset' => 'Elektrikal',
                'kategori_aset' => 'asset',
                'tarikh_perolehan' => '2021-06-15',
                'kaedah_perolehan' => 'Pembelian',
                'nilai_perolehan' => 1800.00,
                'diskaun' => 200.00,
                'umur_faedah_tahunan' => 7,
                'pembekal' => 'LG Malaysia',
                'jenama' => 'LG',
                'tempoh_jaminan' => '3 tahun',
                'tarikh_tamat_jaminan' => '2024-06-15',
                'status_aset' => 'Sedang Digunakan',
                'keadaan_fizikal' => 'Baik',
                'status_jaminan' => 'Tamat',
                'catatan' => 'Mesin basuh untuk kegunaan umum',
