...
class AssetFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'tarikh_pemeriksaan_terakhir' => $this->faker->optional()->dateTimeBetween('-1 year', 'now'),
            'tarikh_penyelenggaraan_akan_datang' => $this->faker->optional()->dateTimeBetween('now', '+1 year'),
            'catatan_jaminan' => $this->faker->optional()->sentence(),
