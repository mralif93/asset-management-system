            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="flex items-center space-x-4 mt-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <div
                                class="w-2 h-2 {{ auth()->user()->email_verified_at ? 'bg-green-400' : 'bg-red-400' }} rounded-full">
                            </div>
                            <span
                                class="text-emerald-100">{{ auth()->user()->email_verified_at ? 'Aktif' : 'Tidak Aktif' }}</span>
                        </div>
                        <div class="flex items-center space-x-2">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" class="p-6 space-y-6">
                        ...
                        @if($user->masjidSurau)
                            <div class="space-y-4">
                                <h3 class="text-lg font-medium text-gray-900 border-b border-gray-200 pb-2">Maklumat Organisasi
                                </h3>
                                ...
                                <div class="bg-gray-50 rounded-lg p-4">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500">{{ $user->masjidSurau->daerah }},
                                                {{ $user->masjidSurau->negeri }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
