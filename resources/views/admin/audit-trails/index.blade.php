                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-500">Belum ada aktiviti yang direkodkan mengikut kriteria yang dipilih.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
        ...
        <div class="bg-white rounded-xl max-w-md w-full p-6">
            ...
            <form action="{{ route('admin.audit-trails.cleanup') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <select id="days" name="days" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
