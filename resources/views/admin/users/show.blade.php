            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="flex items-center space-x-4 mt-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <div
                                class="w-3 h-3 {{ $user->email_verified_at ? 'bg-green-400' : 'bg-red-400' }} rounded-full">
                            </div>
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            @else
                                <span
                                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800 mt-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $user->masjidSurau->nama ?? 'Tidak ditetapkan' }}</dd>
                            @if($user->masjidSurau)
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="flex items-center">
                                <span
                                    ...
                                    <div
                                        class="w-2 h-2 {{ $user->email_verified_at ? 'bg-green-500' : 'bg-red-500' }} rounded-full mr-2">
                                    </div>
                            ...
                            @if($user->id !== auth()->id())
                                <form action="{{ route('admin.users.toggle-status', $user) }}" method="POST" class="w-full">
                                    ...
                                    <button type="submit"
                                        ...
                                        <i
                                            class='bx {{ $user->email_verified_at ? 'bx-toggle-left' : 'bx-toggle-right' }} mr-2'></i>
                                        {{ $user->email_verified_at ? 'Nyahaktifkan' : 'Aktifkan' }}
                                    </button>
                                </form>
                            @endif
                    ...
                    <div class="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-6 border border-green-200">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span
                                    class="font-semibold text-green-700">{{ count($stats['recent_activities'] ?? []) }}</span>
                            </div>
                        </div>
                    </div>
