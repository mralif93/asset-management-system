...
@section('content')
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-1">
                    {{ $maintenanceRecords->where('tarikh_penyelenggaraan', '>=', now()->startOfMonth())->count() }}</h3>
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-1">RM
                    {{ number_format($maintenanceRecords->sum('kos_penyelenggaraan'), 0) }}</h3>
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-1">
                    {{ $maintenanceRecords->where('jenis_penyelenggaraan', 'Pencegahan')->count() }}</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <!-- Export Data -->
            <a href="{{ route('admin.maintenance-records.export', request()->query()) }}"
                onclick="openExportConfirm(event, this.href, 'Adakah anda pasti mahu eksport data penyelenggaraan?')"
                class="group bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div
            ...
            <a href="{{ route('admin.maintenance-records.import') }}"
                ...
                <p class="text-sm text-gray-600">Muat naik rekod penyelenggaraan</p>
            </a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select id="jenis" name="jenis"
                            ...
                            <option value="Pencegahan" {{ request('jenis') === 'Pencegahan' ? 'selected' : '' }}>Pencegahan
                            </option>
                            <option value="Pembaikan" {{ request('jenis') === 'Pembaikan' ? 'selected' : '' }}>Pembaikan
                            </option>
                            <option value="Kalibrasi" {{ request('jenis') === 'Kalibrasi' ? 'selected' : '' }}>Kalibrasi
                            </option>
                            <option value="Pembersihan" {{ request('jenis') === 'Pembersihan' ? 'selected' : '' }}>Pembersihan
                            </option>
                        </select>
                    </div>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">RM
                                        {{ number_format($record->kos_penyelenggaraan, 2) }}</div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-3">
                                        ...
                                        <form action="{{ route('admin.maintenance-records.destroy', $record) }}" method="POST"
                                            class="inline"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-400 text-sm mb-4">Cuba tukar kriteria carian anda atau tambah rekod
                                            baharu</p>
                                        <a href="{{ route('admin.maintenance-records.create') }}"
