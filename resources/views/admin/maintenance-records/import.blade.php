...
@section('title', 'Import Penyelenggaraan')
@section('page-title', 'Import Penyelenggaraan')
@section('page-description', 'Muat naik rekod penyelenggaraan aset dari fail Excel/CSV')
    ...
    <div class="p-6">
        ...
        <div class="bg-emerald-600 rounded-2xl p-8 text-white mb-8 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold mb-2">Import Penyelenggaraan</h1>
                    <p class="text-emerald-100 text-lg">Muat naik rekod penyelenggaraan aset secara pukal dari fail
                        Excel/CSV</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div
                    ...
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-emerald-700">Ikuti langkah-langkah untuk import rekod penyelenggaraan</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Masukkan data penyelenggaraan. Pastikan No. Siri Aset
                                    adalah tepat</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <form action="{{ route('admin.maintenance-records.import.store') }}" method="POST"
                        ...
                        <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-emerald-50 to-green-50">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Pilih fail CSV/Excel yang mengandungi data
                                        penyelenggaraan</p>
                                </div>
                                <div
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="text-blue-700 leading-relaxed space-y-1">
                                            ...
                                            <p>• Jenis: <strong>Pencegahan, Pembaikan, Kalibrasi, Pembersihan</strong></p>
                                            <p>• Status: <strong>Selesai, Dalam Proses, Belum Selesai</strong></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    ...
                    <a href="{{ route('admin.maintenance-records.import.template') }}"
                ...
                <!-- Jenis Penyelenggaraan Card -->
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-center mb-4">
                        <div class="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center mr-3">
                            <i class='bx bx-cog text-white'></i>
                        </div>
                        <h3 class="font-semibold text-gray-900">Jenis Sah</h3>
                    </div>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-center mb-4">
                        <div class="w-10 h-10 bg-emerald-500 rounded-lg flex items-center justify-center mr-3">
                            <i class='bx bx-stats text-white'></i>
                        </div>
                        <h3 class="font-semibold text-gray-900">Status Sah</h3>
                    </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                previewBtn.onclick = async () => {
                    ...
                    try {
                        const response = await fetch('{{ route("admin.maintenance-records.import.preview") }}', {
                            method: 'POST',
                            body: formData
                        });
