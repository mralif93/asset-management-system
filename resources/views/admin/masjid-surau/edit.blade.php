...
<div class="p-6">
    ...
    <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-2xl p-8 text-white mb-8 shadow-lg">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-emerald-100 text-lg">Kemaskini maklumat {{ $masjidSurau->nama }}</p>
                <div class="flex items-center space-x-4 mt-4">
                    <div class="flex items-center space-x-2">
                        <i class='bx bx-edit text-emerald-200'></i>
                        <span class="text-emerald-100">Mode kemaskini</span>
                    </div>
                    <div class="flex items-center space-x-2">
    ...
    <div class="mb-6">
        <nav class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <i class='bx bx-chevron-right text-gray-400'></i>
            <a href="{{ route('admin.masjid-surau.show', $masjidSurau) }}" class="hover:text-emerald-600 transition-colors">
                {{ $masjidSurau->nama }}
            </a>
            <i class='bx bx-chevron-right text-gray-400'></i>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <form action="{{ route('admin.masjid-surau.update', $masjidSurau) }}" method="POST" x-data="masjidForm()" class="space-y-8">
                @csrf
                @method('PUT')
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                <div class="p-6 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900">Maklumat Semasa</h3>
                    <p class="text-sm text-gray-600">Maklumat yang disimpan sekarang</p>
                </div>
                <div class="p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span>{{ $masjidSurau->status }}</span>
                        </div>
                        @if($masjidSurau->imam_ketua)
                        <div class="flex items-center space-x-2">
                            <i class='bx bx-user text-gray-400'></i>
                            <span>{{ $masjidSurau->imam_ketua }}</span>
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="bg-blue-50 rounded-xl border border-blue-200 p-6">
                <div class="flex items-center space-x-3 mb-4">
                    <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                        <i class='bx bx-bar-chart text-blue-600 text-lg'></i>
                    </div>
                    <h3 class="font-semibold text-blue-900">Statistik</h3>
                </div>
                <div class="space-y-3 text-sm text-blue-800">
                    <div class="flex justify-between">
                        <span>Aset Terdaftar:</span>
                        <span class="font-medium">{{ $masjidSurau->assets->count() }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Pengguna Aktif:</span>
                        <span class="font-medium">{{ $masjidSurau->users->count() }}</span>
                    </div>
