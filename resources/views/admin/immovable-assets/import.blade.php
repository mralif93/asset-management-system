    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Isi maklumat aset tak alih dalam template CSV. Pastikan format tarikh adalah YYYY-MM-DD</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                <form action="{{ route('admin.immovable-assets.import.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="p-6 space-y-6">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    ...
                                    <ul class="text-blue-700 leading-relaxed space-y-1">
                                        <li>• Pastikan fail CSV menggunakan format UTF-8 untuk sokongan aksara Melayu</li>
                        ...
                        <div class="flex items-center space-x-4">
                            <button type="submit" class="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center">
                                <i class='bx bx-upload mr-2'></i>
                                Muat Naik & Import
                            </button>
                            <a href="{{ route('admin.immovable-assets.index') }}" class="flex-1 bg-gray-600 hover:bg-gray-700 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <a href="{{ route('admin.immovable-assets.import.template') }}" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center">
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div class="mb-4">
                    <div class="relative">
                        ...
                        <input type="text" 
                               id="masjidSearch" 
                               placeholder="Cari nama masjid/surau..." 
                ...
                <!-- Results Container -->
                <div id="masjidResults" class="space-y-2 max-h-64 overflow-y-auto border border-gray-200 rounded-lg p-3 bg-gray-50">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-xs px-2 py-0.5 rounded-full {{ $masjid->jenis === 'Masjid' ? 'bg-blue-100 text-blue-800' : ($masjid->jenis === 'Surau Jumaat' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800') }}">
                                        {{ $masjid->jenis ?? 'Surau' }}
                                    </span>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showNotification(message, type) {
        ...
        notification.className = `notification-toast fixed top-4 right-4 z-50 px-6 py-4 rounded-lg shadow-lg flex items-center space-x-3 ${
