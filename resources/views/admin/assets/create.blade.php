                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="lokasi_penempatan" name="lokasi_penempatan" required
                                            ...
                                            @foreach(\App\Helpers\SystemData::getValidLocations() as $location)
                                                <option value="{{ $location }}" {{ old('lokasi_penempatan') === $location ? 'selected' : '' }}>
                                                    {{ $location }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="md:col-span-2 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <textarea id="pembekal_alamat" name="pembekal_alamat" rows="2"
                                            x-model="form.pembekal_alamat"
                                            class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 @error('pembekal_alamat') border-red-500 @enderror bg-white"
                                            placeholder="Alamat penuh pembekal">{{ old('pembekal_alamat') }}</textarea>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="pembekal_no_telefon" name="pembekal_no_telefon"
                                                value="{{ old('pembekal_no_telefon') }}" x-model="form.pembekal_no_telefon"
        ...
        <script>
            function assetForm() {
                ...
                const categoryMapping = {
                    ...
                    'Harta Modal': 'General Plant & Machinery',
                    'Inventori': 'Office Equipment',
                    'Lain-lain': 'Office Equipment'
                };
