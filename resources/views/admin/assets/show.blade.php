    ...
    <div class="p-6">
        ...
        <div class="flex items-center justify-end mb-8">
            <div class="flex space-x-3">
                ...
                <form action="{{ route('admin.assets.destroy', $asset) }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" onclick="return confirm('Adakah anda pasti ingin memadamkan aset ini?')"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-emerald-900">RM {{ number_format($asset->nilai_perolehan, 2) }}
                        </p>
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-emerald-700">Susut Nilai Tahunan</p>
                        <p class="text-2xl font-bold text-emerald-900">RM
                            {{ number_format($asset->getAnnualDepreciation() ?? 0, 2) }}</p>
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-emerald-600 mt-1">
                            Susut nilai terkumpul: RM {{ number_format($totalDepreciation, 2) }}
                        </p>
                    </div>
                    <div class="w-12 h-12 bg-emerald-500 rounded-xl flex items-center justify-center">
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="flex items-center">
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $asset->status_aset === 'Sedang Digunakan' ? 'bg-green-100 text-green-800' : ($asset->status_aset === 'Dalam Penyelenggaraan' ? 'bg-yellow-100 text-yellow-800' : ($asset->status_aset === 'Baru' ? 'bg-blue-100 text-blue-800' : 'bg-red-100 text-red-800')) }}">
                                    <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $asset->tarikh_perolehan ? $asset->tarikh_perolehan->format('d/m/Y') : '-' }}</dd>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">RM
                                {{ number_format($asset->nilai_perolehan, 2) }}</dd>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">RM {{ number_format($asset->diskaun ?? 0, 2) }}
                            </dd>
                        </div>
                        ...
                        @if($asset->dokumen_resit_url)
                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    <a href="{{ $asset->dokumen_resit_url }}" target="_blank"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            @if($asset->tarikh_tamat_jaminan)
                                <div class="bg-white rounded-lg p-4 border border-gray-200">
                                    ...
                                    <dd class="text-lg font-semibold text-gray-900">
                                        {{ $asset->tarikh_tamat_jaminan->format('d/m/Y') }}</dd>
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $asset->pegawai_bertanggungjawab_lokasi ?: '-' }}</dd>
                        </div>
                        ...
                        @if($asset->umur_faedah_tahunan)
                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                <div class="flex items-center mb-2">
                                    ...
                                    <dt class="text-sm font-medium text-gray-600">Tempoh Hayat</dt>
                                </div>
                        ...
                        @if($asset->tarikh_pemeriksaan_terakhir)
                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    {{ $asset->tarikh_pemeriksaan_terakhir->format('d/m/Y') }}</dd>
                                <p class="text-xs text-gray-500 mt-1">{{ $asset->tarikh_pemeriksaan_terakhir->diffForHumans() }}
                                </p>
                            </div>
                        @endif
                        ...
                        @if($asset->tarikh_penyelenggaraan_akan_datang)
                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    {{ $asset->tarikh_penyelenggaraan_akan_datang->format('d/m/Y') }}</dd>
                                <p class="text-xs text-gray-500 mt-1">
                                    {{ $asset->tarikh_penyelenggaraan_akan_datang->diffForHumans() }}</p>
                            </div>
                        @endif
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                        <div class="text-center">
                            ...
                            <div class="flex items-center justify-center space-x-2 mt-3">
                                ...
                                <span
                                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium {{ $asset->status_aset === 'Sedang Digunakan' ? 'bg-green-100 text-green-800' : ($asset->status_aset === 'Dalam Penyelenggaraan' ? 'bg-yellow-100 text-yellow-800' : ($asset->status_aset === 'Baru' ? 'bg-blue-100 text-blue-800' : 'bg-red-100 text-red-800')) }}">
                                    {{ $asset->status_aset }}
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('admin.assets.edit', $asset) }}"
                                ...
                                <i
                                    class='bx bx-edit mr-2 text-lg group-hover:scale-110 transition-transform duration-200'></i>
                            ...
                            <button onclick="window.print()"
                                class="group w-full flex items-center justify-center px-4 py-3 bg-white hover:bg-emerald-50 text-emerald-700 hover:text-emerald-800 rounded-lg border border-emerald-200 hover:border-emerald-300 shadow-sm hover:shadow-md transition-all duration-200 transform hover:-translate-y-0.5">
                                <i
                                    class='bx bx-printer mr-2 text-lg group-hover:scale-110 transition-transform duration-200'></i>
                            ...
                            <a href="{{ route('admin.assets.index') }}"
                                class="group w-full flex items-center justify-center px-4 py-3 bg-white hover:bg-emerald-50 text-emerald-700 hover:text-emerald-800 rounded-lg border border-emerald-200 hover:border-emerald-300 shadow-sm hover:shadow-md transition-all duration-200 transform hover:-translate-y-0.5">
                                <i
                                    class='bx bx-list-ul mr-2 text-lg group-hover:scale-110 transition-transform duration-200'></i>
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span
                                    class="font-semibold text-emerald-700">{{ $asset->tarikh_perolehan ? (int) $asset->tarikh_perolehan->diffInYears(now()) : 0 }}
                                    tahun</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600">Nilai Perolehan:</span>
                                <span class="font-semibold text-emerald-700">RM
                            ...
                            @if($asset->susut_nilai_tahunan)
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-semibold text-emerald-700">RM
                                        {{ number_format($asset->susut_nilai_tahunan, 2) }}/tahun</span>
                                </div>
                            @endif
                        </div>
                    </div>
