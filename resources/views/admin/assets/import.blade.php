    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Isi maklumat aset dalam template CSV. Pastikan format tarikh adalah YYYY-MM-DD</p>
                        </div>
                    </div>
                ...
                <form action="{{ route('admin.assets.import.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <a href="{{ route('admin.assets.index') }}" class="flex-1 bg-gray-600 hover:bg-gray-700 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <a href="{{ route('admin.assets.import.template') }}" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center">
