                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" 
                                            onclick="calculateDepreciationEdit()"
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            ...
                                            <div class="relative group animate-fadeIn">
                                                ...
                                                <button type="button" onclick="removeExistingImage('{{ $image }}')" class="absolute -top-3 -right-3 w-8 h-8 bg-red-500 text-white rounded-full flex items-center justify-center text-sm hover:bg-red-600 transition-all duration-200 opacity-0 group-hover:opacity-100 shadow-lg hover:shadow-xl transform hover:scale-110">
                                                    <i class='bx bx-x text-lg'></i>
                                                </button>
                                                <div class="mt-3 p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                                                    <p class="text-sm text-gray-700 truncate font-medium">Gambar {{ $index + 1 }}</p>
                                ...
                                <div class="mt-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl shadow-sm">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 text-sm">
                                            ...
                                            <p class="text-blue-700 leading-relaxed">Anda boleh menambah gambar baru atau menggantikan gambar yang sedia ada. Maksimum 5 gambar keseluruhan untuk setiap aset.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
