                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium" 
                                          :class="{
                                              'bg-green-100 text-green-800': form.status_aset === 'Sedang Digunakan',
                                              'bg-yellow-100 text-yellow-800': form.status_aset === 'Dalam Penyelenggaraan',
                                              'bg-blue-100 text-blue-800': form.status_aset === 'Baru',
                                              'bg-red-100 text-red-800': form.status_aset === 'Rosak'
                                          }">
                                        <div class="w-2 h-2 rounded-full mr-1" 
                                             :class="{
                                                 'bg-green-500': form.status_aset === 'Sedang Digunakan',
                                                 'bg-yellow-500': form.status_aset === 'Dalam Penyelenggaraan',
                                                 'bg-blue-500': form.status_aset === 'Baru',
                                                 'bg-red-500': form.status_aset === 'Rosak'
                                             }"></div>
                                        <span x-text="form.status_aset || '{{ $asset->status_aset }}'">{{ $asset->status_aset }}</span>
                                    </span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-600">Status Jaminan:</span>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium" 
                                          :class="{
                                              'bg-green-100 text-green-800': form.status_jaminan === 'Aktif',
                                              'bg-yellow-100 text-yellow-800': form.status_jaminan === 'Tamat',
                                              'bg-gray-100 text-gray-800': form.status_jaminan === 'Tiada Jaminan'
                                          }">
                                        <span x-text="form.status_jaminan || '{{ $asset->status_jaminan ?? 'Tiada Jaminan' }}'">{{ $asset->status_jaminan ?? 'Tiada Jaminan' }}</span>
                                    </span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-600">Keadaan Fizikal:</span>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium" 
                                          :class="{
                                              'bg-emerald-100 text-emerald-800': form.keadaan_fizikal === 'Cemerlang',
                                              'bg-green-100 text-green-800': form.keadaan_fizikal === 'Baik',
                                              'bg-yellow-100 text-yellow-800': form.keadaan_fizikal === 'Sederhana',
                                              'bg-red-100 text-red-800': form.keadaan_fizikal === 'Rosak' || form.keadaan_fizikal === 'Tidak Boleh Digunakan'
                                          }">
                                        <span x-text="form.keadaan_fizikal || '{{ $asset->keadaan_fizikal ?? 'Baik' }}'">{{ $asset->keadaan_fizikal ?? 'Baik' }}</span>
                                    </span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-600">Jenis Aset:</span>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                        <span x-text="form.jenis_aset || '{{ $asset->jenis_aset }}'">{{ $asset->jenis_aset }}</span>
                                    </span>
                                </div>
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium" 
                                          :class="{
                                              'bg-emerald-100 text-emerald-800': (form.kategori_aset || '{{ $asset->kategori_aset }}') === 'asset',
                                              'bg-orange-100 text-orange-800': (form.kategori_aset || '{{ $asset->kategori_aset }}') === 'non-asset'
                                          }">
                                        <span x-text="(form.kategori_aset || '{{ $asset->kategori_aset }}') === 'asset' ? 'Asset' : 'Non-Asset'">{{ $asset->kategori_aset === 'asset' ? 'Asset' : 'Non-Asset' }}</span>
                                    </span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-600">Lokasi:</span>
