                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="lokasi_penempatan" name="lokasi_penempatan" required
                                            ...
                                            <option value="">-- Pilih --</option>
                                            <option value="Anjung kiri" {{ old('lokasi_penempatan', $asset->lokasi_penempatan) == 'Anjung kiri' ? 'selected' : '' }}>Anjung kiri
                                            </option>
                                            <option value="Anjung kanan" {{ old('lokasi_penempatan', $asset->lokasi_penempatan) == 'Anjung kanan' ? 'selected' : '' }}>Anjung kanan
                                            </option>
                                            ...
                                            <option value="Ruang Utama (tingkat atas, tingkat bawah)" {{ old('lokasi_penempatan', $asset->lokasi_penempatan) == 'Ruang Utama (tingkat atas, tingkat bawah)' ? 'selected' : '' }}>Ruang Utama (tingkat atas,
                                                tingkat bawah)</option>
                                            <option value="Bilik Mesyuarat" {{ old('lokasi_penempatan', $asset->lokasi_penempatan) == 'Bilik Mesyuarat' ? 'selected' : '' }}>Bilik
                                                Mesyuarat</option>
                                            <option value="Bilik Kuliah" {{ old('lokasi_penempatan', $asset->lokasi_penempatan) == 'Bilik Kuliah' ? 'selected' : '' }}>Bilik Kuliah
                                            </option>
                                            <option value="Bilik Bendahari" {{ old('lokasi_penempatan', $asset->lokasi_penempatan) == 'Bilik Bendahari' ? 'selected' : '' }}>Bilik
                                                Bendahari</option>
                                            <option value="Bilik Setiausaha" {{ old('lokasi_penempatan', $asset->lokasi_penempatan) == 'Bilik Setiausaha' ? 'selected' : '' }}>Bilik
                                                Setiausaha</option>
                                            <option value="Bilik Nazir & Imam" {{ old('lokasi_penempatan', $asset->lokasi_penempatan) == 'Bilik Nazir & Imam' ? 'selected' : '' }}>Bilik
                                                Nazir & Imam</option>
                                            <option value="Bangunan Jenazah" {{ old('lokasi_penempatan', $asset->lokasi_penempatan) == 'Bangunan Jenazah' ? 'selected' : '' }}>Bangunan
                                                Jenazah</option>
                                            <option value="Lain-lain" {{ old('lokasi_penempatan', $asset->lokasi_penempatan) == 'Lain-lain' ? 'selected' : '' }}>Lain-lain
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="diskaun" name="diskaun" step="0.01" min="0"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="susut_nilai_tahunan" name="susut_nilai_tahunan" step="0.01"
                                            min="0" value="{{ old('susut_nilai_tahunan', $asset->susut_nilai_tahunan) }}"
                                            oninput="calculateDepreciationEdit()"
        ...
        <script>
            ...
            function calculateDepreciationEdit() {
                ...
                if (cost > 0 && usefulLife > 0) {
                    ...
                    calculatedDisplay.textContent = 'Dikira: RM ' + annualDepreciation.toFixed(2) + ' (Straight-Line Method)';
