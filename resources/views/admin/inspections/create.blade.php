                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p class="font-medium text-gray-900"
                                                x-text="form.asset_id ? 'Aset Dipilih' : 'Pilih Aset'">Pilih Aset</p>
                                            <p class="text-sm text-gray-500"
                                                x-text="form.tarikh_pemeriksaan || 'Tarikh pemeriksaan'">Tarikh pemeriksaan
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span class="text-sm font-medium"
                                                x-text="form.tarikh_pemeriksaan_akan_datang || '-'">-</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
