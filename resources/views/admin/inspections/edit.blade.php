                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select id="kondisi_aset" 
                                        ...
                                        <option value="Sedang Digunakan" {{ old('kondisi_aset', $inspection->kondisi_aset) == 'Sedang Digunakan' ? 'selected' : '' }}>Sedang Digunakan</option>
                                        <option value="Tidak Digunakan" {{ old('kondisi_aset', $inspection->kondisi_aset) == 'Tidak Digunakan' ? 'selected' : '' }}>Tidak Digunakan</option>
                                        <option value="Rosak" {{ old('kondisi_aset', $inspection->kondisi_aset) == 'Rosak' ? 'selected' : '' }}>Rosak</option>
                                        <option value="Sedang Diselenggara" {{ old('kondisi_aset', $inspection->kondisi_aset) == 'Sedang Diselenggara' ? 'selected' : '' }}>Sedang Diselenggara</option>
