                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select id="kondisi" name="kondisi"
                            ...
                            <option value="Sederhana" {{ request('kondisi') === 'Sederhana' ? 'selected' : '' }}>Sederhana
                            </option>
                    ...
                    <div>
                        ...
                        <input type="date" id="tarikh" name="tarikh" value="{{ request('tarikh') }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                    </div>
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Tarikh Pemeriksaan</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Kondisi</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Pemeriksaan Akan Datang</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Pemeriksa</th>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">{{ $inspection->asset->nama_aset }}
                                            </div>
                                            <div class="text-sm text-gray-500">{{ $inspection->asset->no_siri_pendaftaran }}
                                            </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($inspection->tarikh_pemeriksaan_akan_datang)
                                        <div class="text-sm text-gray-900">
                                            {{ \Carbon\Carbon::parse($inspection->tarikh_pemeriksaan_akan_datang)->format('d/m/Y') }}
                                        </div>
                                        <div class="text-xs text-gray-500">
                                            {{ \Carbon\Carbon::parse($inspection->tarikh_pemeriksaan_akan_datang)->diffForHumans() }}
                                        </div>
                                    @else
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-400 text-sm">Cuba tukar kriteria carian anda atau tambah pemeriksaan
                                            baharu</p>
                                        <a href="{{ route('admin.inspections.create') }}"
