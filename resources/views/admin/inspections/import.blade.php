...
@section('title', 'Import Pemeriksaan')
@section('page-title', 'Import Pemeriksaan')
@section('page-description', 'Muat naik rekod pemeriksaan aset dari fail Excel/CSV')
    ...
    <div class="p-6">
        ...
        <div class="bg-emerald-600 rounded-2xl p-8 text-white mb-8 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold mb-2">Import Pemeriksaan</h1>
                    <p class="text-emerald-100 text-lg">Muat naik rekod pemeriksaan aset secara pukal dari fail Excel/CSV
                    </p>
                ...
                <div class="hidden md:block">
                    <i class='bx bx-check-shield text-6xl text-emerald-200'></i>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center space-x-2 mb-6">
            ...
            <i class='bx bx-chevron-right text-gray-400'></i>
            <span class="text-emerald-600 font-medium">Import Rekod</span>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div
                    ...
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-emerald-700">Ikuti langkah-langkah untuk import rekod pemeriksaan</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Masukkan data pemeriksaan. Pastikan No. Siri Aset adalah
                                    tepat</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <form action="{{ route('admin.inspections.import.store') }}" method="POST" enctype="multipart/form-data"
                        id="importForm">
                        @csrf
                        ...
                        <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-emerald-50 to-green-50">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Pilih fail CSV/Excel yang mengandungi data pemeriksaan
                                    </p>
                                </div>
                                <div
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="text-blue-700 leading-relaxed space-y-1">
                                            ...
                                            <p>• Kondisi Fizikal: <strong>Baik, Sederhana, Rosak, Sedang Digunakan, Tidak
                                                    Digunakan</strong></p>
                                            <p>• Cadangan Tindakan: <strong>Tiada Tindakan, Penyelenggaraan, Pelupusan,
                                                    Hapus Kira</strong></p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    ...
                    <a href="{{ route('admin.inspections.import.template') }}"
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="font-semibold text-gray-900">Kondisi Aset Sah</h3>
                    </div>
                ...
                <!-- Cadangan Tindakan Card -->
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-center mb-4">
                        <div class="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center mr-3">
                            <i class='bx bx-list-check text-white'></i>
                        </div>
                        <h3 class="font-semibold text-gray-900">Cadangan Tindakan</h3>
                    </div>

                    <div class="space-y-2">
                        <div class="flex items-center text-sm text-gray-700">
                            <i class='bx bx-check-circle text-blue-600 mr-2'></i>
                            <span>Tiada Tindakan</span>
                        </div>
                        <div class="flex items-center text-sm text-gray-700">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                previewBtn.onclick = async () => {
                    ...
                    try {
                        const response = await fetch('{{ route("admin.inspections.import.preview") }}', {
                            method: 'POST',
                            body: formData
                        });
                    ...
                    tableBody.innerHTML = pageRows.map(row => {
                        ...
                        return `
                                        <tr class="${row.valid ? 'hover:bg-gray-50' : 'bg-red-50'}">
                                            ...
                                            <td class="px-6 py-4 text-gray-700">${row.display_data?.kondisi || '-'}</td>
                ...
                window.copyToClipboard = (id, name) => {
                    navigator.clipboard.writeText(id).then(() => {
                        ...
                        item.classList.add('bg-indigo-50', 'ring-2', 'ring-indigo-400');
                        setTimeout(() => item.classList.remove('bg-indigo-50', 'ring-2', 'ring-indigo-400'), 1500);
                    });
                };
