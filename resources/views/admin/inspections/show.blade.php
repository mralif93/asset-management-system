    ...
    <div class="p-6">
        ...
        <div class="bg-emerald-600 rounded-2xl p-8 text-white mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-emerald-100 text-lg">Paparan lengkap untuk {{ $inspection->asset->nama_aset }} -
        ...
        ($inspection->kondisi_aset === 'Sederhana' ? 'bg-yellow-400' : 'bg-red-400') 
                ...
                <div class="hidden md:block">
                    <div
                        class="w-20 h-20 bg-emerald-500 rounded-2xl flex items-center justify-center text-3xl text-white shadow-xl">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-900">RM
                            {{ number_format($inspection->asset->nilai_perolehan, 0) }}</p>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-amber-900">
                            {{ $inspection->asset->tarikh_perolehan ? number_format($inspection->asset->tarikh_perolehan->floatDiffInYears(now()), 0) : 0 }}
                        </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $inspection->tarikh_pemeriksaan->format('d/m/Y') }}</dd>
        ...
        ($inspection->kondisi_aset === 'Sederhana' ? 'bg-yellow-500' : 'bg-red-500') 
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $inspection->nama_pemeriksa ?: 'Tidak diketahui' }}
                            </dd>
                            
                            @if($inspection->signature)
                                <div class="mt-4 border-t border-gray-100 pt-3">
                                    <p class="text-xs font-medium text-gray-500 mb-2">Tandatangan:</p>
                                    <div class="bg-gray-50 p-2 rounded border border-gray-100 inline-block">
                                        <img src="{{ $inspection->signature }}" alt="Tandatangan Pemeriksa" class="h-16 object-contain">
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        @if($inspection->tarikh_pemeriksaan_akan_datang)
                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                ...
                                <dd class="text-lg font-semibold text-gray-900">
                                    {{ $inspection->tarikh_pemeriksaan_akan_datang->format('d/m/Y') }}</dd>
                                @php
                                    $daysUntilNext = now()->diffInDays($inspection->tarikh_pemeriksaan_akan_datang, false);
                                @endphp
                                @if($daysUntilNext > 0)
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $inspection->created_at->format('d/m/Y H:i') }}</dd>
                    ...
                    @if($inspection->tindakan_diperlukan)
                        <div class="mt-6 bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-gray-900 bg-orange-50 p-3 rounded-lg border-l-4 border-orange-400">
                                {{ $inspection->tindakan_diperlukan }}</dd>
                        </div>
                    @endif
                </div>
        ...
        ($inspection->asset->status_aset === 'Dalam Penyelenggaraan' ? 'bg-yellow-500' : 'bg-red-500') 
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">RM
                                {{ number_format($inspection->asset->nilai_perolehan, 2) }}</dd>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="space-y-3">
                                @foreach($relatedInspections as $related)
                                    <div
                                        ...
                                        <div>
                                            <p class="font-medium text-gray-900">{{ $related->tarikh_pemeriksaan->format('d/m/Y') }}
                                            </p>
                    ...
                    <div class="bg-gradient-to-br from-amber-50 to-orange-100 rounded-xl p-6 border border-amber-200">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="mt-3 pt-3 border-t border-amber-200">
                                ...
                                @if($inspection->tarikh_pemeriksaan_akan_datang)
                                    <p class="text-amber-700">Seterusnya:
                                        {{ $inspection->tarikh_pemeriksaan_akan_datang->format('d/m/Y') }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
