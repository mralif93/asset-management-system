                            ...
                            <div x-show="form.kaedah_pelupusan === 'Dijual'" x-cloak>
                                ...
                                <div class="relative">
                                    <input type="text" 
                                           ...
                                           value="{{ old('hasil_pelupusan', $disposal->hasil_pelupusan) ? number_format(old('hasil_pelupusan', $disposal->hasil_pelupusan), 2) : '' }}" 
                                           oninput="formatDisposalPriceEdit(event, 'hasil_pelupusan')"
                                           onblur="formatDisposalPriceBlurEdit(event, 'hasil_pelupusan')"
    ...
    function editDisposalForm() {
        return {
            form: {
                ...
                hasil_pelupusan: '{{ old('hasil_pelupusan', $disposal->hasil_pelupusan) }}',
