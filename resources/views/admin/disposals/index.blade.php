    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-1">
                    {{ number_format($disposals->sum('nilai_pelupusan') ?? 0, 0) }}</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <!-- Export Data -->
            <a href="{{ route('admin.disposals.export', request()->query()) }}"
                onclick="openExportConfirm(event, this.href, 'Adakah anda pasti mahu eksport data pelupusan?')"
                ...
                <p class="text-sm text-gray-600">Muat turun laporan pelupusan (.xlsx)</p>
            </a>
            ...
            <!-- Import Disposal -->
            <a href="{{ route('admin.disposals.import') }}"
                class="group bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div
                ...
                <p class="text-sm text-gray-600">Import permohonan pelupusan secara pukal</p>
            </a>

            <!-- Approval Queue -->
            <a href="{{ route('admin.disposals.index', ['status' => 'Dimohon']) }}"
                class="group bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div
                        class="w-12 h-12 bg-amber-100 rounded-lg flex items-center justify-center group-hover:bg-amber-200 transition-colors">
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Sebab
                                & Kaedah</th>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">{{ $disposal->asset->nama_aset }}
                                            </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">RM
                                        {{ number_format($disposal->nilai_pelupusan ?? 0, 2) }}</div>
                                    @if($disposal->nilai_baki)
                                        <div class="text-xs text-gray-500">Baki: RM {{ number_format($disposal->nilai_baki, 2) }}
                                        </div>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-3">
                                        ...
                                        <form action="{{ route('admin.disposals.destroy', $disposal) }}" method="POST"
                                            class="inline"
                ...
                <div class="mt-2 px-7 py-3">
                    <form id="rejectForm" method="POST">
                        ...
                        <textarea name="sebab_penolakan"
                            ...
                            rows="4" placeholder="Nyatakan sebab penolakan..." required></textarea>
