        ...
        <div class="bg-emerald-600 rounded-2xl p-8 text-white mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-emerald-100 text-lg">Paparan lengkap laporan kehilangan
                        {{ $lossWriteoff->asset->nama_aset }}</p>
                ...
                <div class="hidden md:block">
                    <div
                        class="w-20 h-20 bg-red-500 rounded-2xl flex items-center justify-center text-3xl font-bold text-white shadow-xl">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-900">RM
                            {{ number_format($lossWriteoff->asset->nilai_semasa ?? $lossWriteoff->asset->nilai_perolehan, 2) }}
                        </p>
            ...
            <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border border-red-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-900">RM
                            {{ number_format($lossWriteoff->nilai_kehilangan, 2) }}</p>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-amber-900">
                            {{ $lossWriteoff->asset->created_at->diffInYears(now()) }}</p>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-900">{{ $lossWriteoff->tarikh_laporan->diffInDays(now()) }}
                        </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $lossWriteoff->tarikh_laporan->format('d/m/Y') }}</dd>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">{{ $lossWriteoff->formatted_incident_reason }}
                            </dd>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-red-600">RM
                                {{ number_format($lossWriteoff->nilai_kehilangan, 2) }}</dd>
                        </div>
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">{{ $lossWriteoff->asset->no_siri_pendaftaran }}
                            </dd>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $lossWriteoff->asset->masjidSurau->nama ?? 'Tidak ditetapkan' }}</dd>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-emerald-600">RM
                                {{ number_format($lossWriteoff->asset->nilai_semasa ?? $lossWriteoff->asset->nilai_perolehan, 2) }}
                            </dd>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $lossWriteoff->asset->tarikh_perolehan->format('d/m/Y') }}</dd>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-gradient-to-br from-amber-50 to-orange-100 rounded-xl p-6 border border-amber-200">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-semibold text-blue-700">RM
                                    {{ number_format($lossWriteoff->asset->nilai_semasa ?? $lossWriteoff->asset->nilai_perolehan, 2) }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600">Nilai Kerugian:</span>
                                <span class="font-semibold text-red-700">RM
                                    {{ number_format($lossWriteoff->nilai_kehilangan, 2) }}</span>
                            </div>
                ...
                <div class="mt-3">
                    ...
                    <form action="{{ route('admin.loss-writeoffs.reject', $lossWriteoff) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="sebab_penolakan" id="sebab_penolakan" rows="4" required
