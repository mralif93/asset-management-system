...
@section('title', 'Import Hapus Kira')
@section('page-title', 'Import Hapus Kira')
@section('page-description', 'Muat naik rekod kehilangan dan hapus kira aset dari fail Excel/CSV')
    ...
    <div class="p-6">
        ...
        <div class="bg-emerald-600 rounded-2xl p-8 text-white mb-8 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold mb-2">Import Hapus Kira</h1>
                    <p class="text-emerald-100 text-lg">Muat naik rekod kehilangan aset secara pukal dari fail Excel/CSV</p>
                ...
                <div class="hidden md:block">
                    <i class='bx bx-file-blank text-6xl text-emerald-200'></i>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div
                    ...
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-emerald-700">Ikuti langkah-langkah untuk import rekod kehilangan</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Masukkan data kehilangan. Pastikan No. Siri Aset adalah
                                    tepat</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <form action="{{ route('admin.loss-writeoffs.import.store') }}" method="POST"
                        ...
                        <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-emerald-50 to-green-50">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Pilih fail CSV/Excel yang mengandungi data kehilangan
                                    </p>
                                </div>
                                <div
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="text-blue-700 leading-relaxed space-y-1">
                                            ...
                                            <p>• Jenis: <strong>hilang, hapus_kira</strong></p>
                                            <p>• Sebab: <strong>bencana_alam, kecurian, kecuaian,
                                                    tidak_dapat_dikesan</strong></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    ...
                    <a href="{{ route('admin.loss-writeoffs.import.template') }}"
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="font-semibold text-gray-900">Jenis Kejadian Sah</h3>
                    </div>

                    <div class="space-y-2">
                        @foreach(['hilang', 'hapus_kira'] as $opt)
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="font-semibold text-gray-900">Sebab Kejadian Sah</h3>
                    </div>

                    <div class="space-y-2">
                        @foreach(['bencana_alam', 'kecurian', 'kecuaian', 'tidak_dapat_dikesan'] as $opt)
                            <div class="flex items-center text-sm text-gray-700">
                                <i class='bx bx-check-circle text-blue-600 mr-2'></i>
                                <span>{{ str_replace('_', ' ', $opt) }}</span>
                            </div>
                        @endforeach
                    </div>
                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                previewBtn.onclick = async () => {
                    ...
                    try {
                        const response = await fetch('{{ route("admin.loss-writeoffs.import.preview") }}', {
                            method: 'POST',
                            body: formData
                        });
