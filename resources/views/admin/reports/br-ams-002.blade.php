...
<div class="p-6">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 mb-8">
        ...
        <div class="text-center mb-8">
            <div class="text-left text-sm text-gray-600 mb-2">BR-AMS 002</div>
            <h1 class="text-3xl font-bold text-gray-900 mb-4">SENARAI DAFTAR INVENTORI</h1>
            ...
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900 border-r border-gray-200 text-right font-medium">
                            {{ number_format($asset->nilai_perolehan, 2) }}
                        </td>
                ...
                <tfoot class="bg-gray-100">
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right text-sm font-bold text-gray-900 border-r border-gray-200">
                            {{ number_format($totalValue, 2) }}
                        </td>
