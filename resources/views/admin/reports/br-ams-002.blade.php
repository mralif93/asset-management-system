        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-emerald-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 border-r border-gray-200 text-right">
                            <span class="font-semibold text-gray-900">RM {{ number_format($asset->nilai_perolehan, 2) }}</span>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-900 border-r border-gray-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">
                            <span class="font-semibold text-emerald-600">RM {{ number_format($asset->getCurrentValue(), 2) }}</span>
                        </td>
                    </tr>
                    @empty
                    <tr>
                ...
                <tfoot class="bg-emerald-50">
                    <tr>
                        <td colspan="8" class="px-6 py-4 text-right text-sm font-semibold text-emerald-800 border-r border-emerald-200">
