            ...
            <table class="w-full border border-gray-300">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($maintenanceRecords as $index => $record)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-center text-sm text-gray-900 border-r border-gray-300">
                                <div class="font-medium text-right">{{ number_format($record->kos_penyelenggaraan ?? 0, 2) }}
                                </div>
                            </td>
                ...
                @if($maintenanceRecords->count() > 0)
                    <tfoot class="bg-gray-100">
                        <tr>
                            <td colspan="4"
                                class="px-4 py-3 text-right text-sm font-bold text-gray-900 border-r border-gray-300">
