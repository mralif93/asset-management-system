...
@section('page-description', 'Laporan rasmi rekod pelupusan aset alih')
...
<div class="p-6">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h3 class="text-lg font-semibold text-gray-900">Senarai Pelupusan Aset</h3>
            <p class="text-sm text-gray-600">Data pelupusan aset mengikut kriteria yang dipilih</p>
        </div>
            ...
            <table class="w-full">
                <thead class="bg-emerald-50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-center text-xs font-semibold text-emerald-800 uppercase tracking-wider border-r border-emerald-200">NOMBOR SIRI PENDAFTARAN ASET</th>
                        ...
                        <th class="px-6 py-4 text-center text-xs font-semibold text-emerald-800 uppercase tracking-wider border-r border-emerald-200">USIA ASET DIGUNAKAN</th>
                        <th class="px-6 py-4 text-center text-xs font-semibold text-emerald-800 uppercase tracking-wider border-r border-emerald-200">TARIKH PEMBELIAN</th>
                        <th class="px-6 py-4 text-center text-xs font-semibold text-emerald-800 uppercase tracking-wider border-r border-emerald-200">HARGA PEMBELIAN (RM)</th>
                        <th class="px-6 py-4 text-center text-xs font-semibold text-emerald-800 uppercase tracking-wider border-r border-emerald-200">JUSTIFIKASI</th>
                        <th class="px-6 py-4 text-center text-xs font-semibold text-emerald-800 uppercase tracking-wider">KAEDAH PELUPUSAN</th>
                    </tr>
                </thead>
                    ...
                    <tr class="hover:bg-emerald-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center text-sm text-gray-900">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                {{ $disposal->formatted_actual_disposal_method }}
                            </span>
                        </td>
                    </tr>
                    @empty
                        ...
                        <td colspan="9" class="px-8 py-16 text-center">
                            <div class="flex flex-col items-center">
                                <div class="bg-emerald-50 rounded-full p-6 mb-4">
                                    <i class='bx bx-trash text-5xl text-emerald-400'></i>
                                </div>
                                <h3 class="text-xl font-semibold text-gray-700 mb-2">Tiada Rekod Pelupusan Ditemui</h3>
                                <p class="text-sm text-gray-500 max-w-md">Tiada rekod pelupusan yang memenuhi kriteria carian. Cuba ubah penapis untuk melihat data lain.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
                ...
                <tfoot class="bg-emerald-50">
                    <tr>
                        <td colspan="6" class="px-6 py-4 text-right text-sm font-bold text-gray-900 border-r border-emerald-200">JUMLAH KESELURUHAN (RM)</td>
                        <td class="px-6 py-4 text-center text-sm font-bold text-gray-900 border-r border-emerald-200">{{ number_format($totalValue, 2) }}</td>
                        <td colspan="2" class="px-6 py-4 text-center text-sm text-gray-900">-</td>
                    </tr>
                </tfoot>
                @endif
            </table>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-8">
        ...
        <div class="space-y-4 text-sm text-gray-700">
            <div>
                <p><strong>Laporan Pelupusan Aset:</strong> Senarai ini memaparkan semua rekod pelupusan aset alih yang telah diluluskan.</p>
            </div>
            <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
                <p><strong>Maklumat Penting:</strong></p>
                <ul class="mt-2 space-y-1 text-xs">
                    <li>• <strong>Tarikh Pelupusan:</strong> Tarikh aset dilupuskan</li>
                    <li>• <strong>Kaedah Pelupusan:</strong> Cara aset dilupuskan (jualan/sumbangan/luat)</li>
                    <li>• <strong>Nilai Pelupusan:</strong> Nilai hasil dari pelupusan (jika ada)</li>
                    <li>• <strong>Kelulusan:</strong> Status kelulusan pelupusan</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div class="flex-1">
                <p class="text-sm text-gray-600">
                    ...
                    *NOTA: Laporan ini melaporkan semua rekod pelupusan aset alih yang telah diluluskan
                </p>
            </div>
