...
<head>
    ...
    <title>BR-AMS 005 - Laporan Pemeriksaan Aset Alih</title>
    <style>
        @page {
            margin: 0;
            size: A4 landscape;
...
<body>
    <div class="header">
        <h1>BR-AMS 005 - LAPORAN PEMERIKSAAN ASET ALIH</h1>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center" style="padding:20px;color:#9ca3af;">Tiada aset ditemui</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    <div class="note-section">
        <p><strong>ℹ️ NOTA:</strong> Laporan ini adalah laporan rasmi pemeriksaan aset alih.</p>
    </div>
    <div class="footer">
