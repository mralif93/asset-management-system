...
<head>
    ...
    <title>BR-AMS 006 - Rekod Penyelenggaraan Aset Alih</title>
    <style>
        @page {
            margin: 0;
            size: A4 landscape;
...
<body>
    <div class="header">
        <h1>BR-AMS 006 - REKOD PENYELENGGARAAN ASET ALIH</h1>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width:20%;">JENIS PENYELENGGARAAN</th>
                <th style="width:10%;">KOS (RM)</th>
        ...
        <tbody>
            @forelse($assets as $index => $asset)
                <tr>
                    ...
                    <td class="text-center">{{ $asset->tarikh_perolehan ?? '-' }}</td>
            ...
            @empty
                <tr>
                    <td colspan="7" class="text-center" style="padding:20px;color:#9ca3af;">Tiada rekod penyelenggaraan ditemui</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    <div class="note-section">
        <p><strong>ℹ️ NOTA:</strong> Laporan ini adalah rekod rasmi penyelenggaraan aset alih.</p>
    </div>
    <div class="footer">
