...
<div class="p-6">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h3 class="text-lg font-semibold text-gray-900">Senarai Rekod Pelupusan</h3>
            ...
            <table class="w-full">
                <thead class="bg-emerald-50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-center text-xs font-semibold text-emerald-800 uppercase tracking-wider border-r border-emerald-200">Kaedah Pelupusan</th>
                        <th class="px-6 py-4 text-center text-xs font-semibold text-emerald-800 uppercase tracking-wider border-r border-emerald-200">Hasil (RM)</th>
                        <th class="px-6 py-4 text-center text-xs font-semibold text-emerald-800 uppercase tracking-wider border-r border-emerald-200">Tarikh</th>
                        <th class="px-6 py-4 text-center text-xs font-semibold text-emerald-800 uppercase tracking-wider">Tempat</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-emerald-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center text-sm text-gray-900 border-r border-gray-200">
                            @if(strtolower($disposal->kaedah_pelupusan) == 'jualan' || strtolower($disposal->kaedah_pelupusan) == 'dijual')
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">{{ $disposal->tempat_pelupusan ?? 'N/A' }}</td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="7" class="px-8 py-16 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-sm text-gray-500 max-w-md">Tiada rekod pelupusan aset yang memenuhi kriteria carian. Cuba ubah penapis untuk melihat data lain.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-8">
        ...
        <div class="space-y-4 text-sm text-gray-700">
            <div>
                <p><strong>Laporan Tindakan Pelupusan Aset:</strong> Senarai ini memaparkan semua rekod pelupusan aset alih yang telah diluluskan.</p>
            </div>
            <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
                ...
                <ul class="mt-2 space-y-1 text-xs">
                    ...
                    <li>• <strong>Hasil Pelupusan:</strong> Nilai hasil dari pelupusan (jika ada)</li>
