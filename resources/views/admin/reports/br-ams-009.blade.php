...
@section('page-description', 'Borang rasmi laporan kehilangan / hapus kira aset alih')
...
<div class="p-6">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 mb-8">
        ...
        <div class="text-center mb-8">
            <div class="text-left text-sm text-gray-600 mb-2">BR-AMS 009</div>
            <h1 class="text-3xl font-bold text-gray-900 mb-6">LAPORAN KEHILANGAN / HAPUS KIRA ASET ALIH</h1>
        </div>
            ...
            <table class="w-full border border-gray-300">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center text-sm text-gray-900 border-r border-gray-300">
                            <div class="font-medium">{{ $lossWriteoff->asset->nombor_siri_pendaftaran ?? 'N/A' }}</div>
                        </td>
                    ...
                    <tr>
                        <td colspan="5" class="px-4 py-12 text-center text-gray-500">
                            <div class="flex flex-col items-center">
                                <i class='bx bx-x-circle text-4xl text-gray-300 mb-4'></i>
                                <p class="text-lg font-medium">Tiada rekod kehilangan ditemui</p>
                                <p class="text-sm">Tiada rekod kehilangan/hapus kira yang memenuhi kriteria carian</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
                ...
                <tfoot class="bg-gray-100">
                    <tr>
                        <td colspan="4" class="px-4 py-3 text-center text-sm font-bold text-gray-900 border-r border-gray-300">
                            JUMLAH KESELURUHAN
                        </td>
