    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-1">{{ number_format($assets->sum('nilai_perolehan'), 0) }}
                </h3>
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-1">{{ number_format($assets->sum('total_depreciation'), 0) }}
                </h3>
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nilai
                                Asal</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Susut
                                Nilai/Tahun</th>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">RM
                                        {{ number_format($asset->nilai_perolehan, 2) }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">RM {{ number_format($asset->susut_nilai_tahunan, 2) }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-red-600">RM
                                        {{ number_format($asset->total_depreciation, 2) }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-green-600">RM
        ...
        <div class="flex justify-end space-x-4 mt-8">
            <a href="{{ route('admin.reports.asset-depreciation.export') }}"
