...
@section('title', 'Import Pergerakan Aset')
@section('page-title', 'Import Pergerakan Aset')
@section('page-description', 'Muat naik rekod pergerakan aset dari fail Excel/CSV')
    ...
    <div class="p-6">
        ...
        <div class="bg-emerald-600 rounded-2xl p-8 text-white mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold mb-2">Import Pergerakan Aset</h1>
                    <p class="text-emerald-100 text-lg">Muat naik rekod pergerakan aset dari fail Excel/CSV</p>
        ...
        <div class="flex items-center space-x-2 mb-6">
            ...
            <i class='bx bx-chevron-right text-gray-400'></i>
            <span class="text-emerald-600 font-medium">Import Pergerakan</span>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-blue-700">Ikuti langkah-langkah untuk import rekod pergerakan</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Gunakan template CSV rasmi untuk format yang tepat</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Masukkan data pergerakan. Pastikan No. Siri Aset adalah
                                    tepat</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                    <form action="{{ route('admin.asset-movements.import.store') }}" method="POST"
                        ...
                        <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-emerald-50 to-blue-50">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Pilih fail CSV yang mengandungi data pergerakan</p>
                                </div>
                                <div class="flex items-center space-x-2">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3 text-sm">
                                        ...
                                        <ul class="text-blue-700 leading-relaxed space-y-1">
                                            ...
                                            <li>• Jenis pergerakan sah: <strong>Pemindahan, Peminjaman, Pulangan</strong></li>
                                            <li>• Kuantiti mestilah nombor bulat dan tidak melebihi stok tersedia</li>
                                            <li>• Format tarikh mesti YYYY-MM-DD (contoh: 2024-01-15)</li>
                                            <li>• Pastikan no. siri aset wujud dalam sistem sebelum import</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="w-full text-sm text-left">
                                <thead class="text-xs text-gray-500 uppercase bg-gray-50 border-b tracking-wider">
                                    <tr>
                                        ...
                                        <th class="px-6 py-4 font-bold">Aset</th>
                                        <th class="px-6 py-4 font-bold">Jenis Pergerakan</th>
                                        <th class="px-6 py-4 font-bold">Kuantiti</th>
                                        <th class="px-6 py-4 font-bold">Catatan / Ralat</th>
                                    </tr>
                                </thead>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    ...
                    <a href="{{ route('admin.asset-movements.import.template') }}"
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="masjidSearch" placeholder="Cari nama atau kod..."
                    ...
                    <div id="masjidResults"
                        ...
                        @foreach($masjidSuraus as $masjid)
                            <div class="masjid-item group p-3 bg-white rounded-lg border border-gray-100 hover:border-emerald-300 hover:shadow-sm transition-all cursor-pointer"
                ...
                <!-- Jenis Pergerakan Card -->
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-center mb-4">
                        <div class="w-10 h-10 bg-indigo-500 rounded-lg flex items-center justify-center mr-3">
                            <i class='bx bx-transfer text-white'></i>
                        </div>
                        <h3 class="font-semibold text-gray-900">Jenis Pergerakan Sah</h3>
                    </div>
                ...
                <!-- Status Pergerakan Card -->
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-center mb-4">
                        <div class="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center mr-3">
                            <i class='bx bx-info-circle text-white'></i>
                        </div>
                        <h3 class="font-semibold text-gray-900">Status Pergerakan</h3>
                    </div>

                    <div class="space-y-2">
                        <div class="flex items-center text-sm text-gray-700">
                            <i class='bx bx-check-circle text-orange-600 mr-2'></i>
                            <span class="font-medium text-orange-700">Menunggu Kelulusan</span>
                        </div>
                        <div class="flex items-center text-sm text-gray-700">
                            <i class='bx bx-check-circle text-green-600 mr-2'></i>
                            <span class="font-medium text-green-700">Diluluskan</span>
                        </div>
                        <div class="flex items-center text-sm text-gray-700">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                previewBtn.onclick = async () => {
                    ...
                    try {
                        const response = await fetch('{{ route("admin.asset-movements.import.preview") }}', {
                            method: 'POST',
                            body: formData
                        });
                    ...
                    tableBody.innerHTML = pageRows.map(row => `
                                    <tr class="${row.valid ? 'hover:bg-gray-50' : 'bg-red-50'}">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="text-[10px] text-gray-500 uppercase">${row.display_data?.no_siri || '-'}</div>
                                        </td>
                                        <td class="px-6 py-4 text-gray-700">${row.display_data?.jenis || '-'}</td>
                                        <td class="px-6 py-4 text-gray-700 font-bold">${row.display_data?.kuantiti || 0}</td>
                                        <td class="px-6 py-4 ${row.valid ? 'text-gray-500 italic' : 'text-red-600 font-semibold'}">
                                            ${row.valid ? (row.data.catatan || '-') : row.errors.join('<br>')}
                                        </td>
                                    </tr>
                                `).join('');
                ...
                const masjidInput = document.getElementById('masjidSearch');
                masjidInput.oninput = function () {
                    const q = this.value.toLowerCase();
                    document.querySelectorAll('.masjid-item').forEach(item => {
