        ...
        <div class="bg-emerald-600 rounded-2xl p-8 text-white mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-emerald-100 text-lg">Paparan lengkap pergerakan {{ $assetMovement->asset->nama_aset }}
                    </p>
                    <div class="flex items-center space-x-4 mt-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span
                                class="text-emerald-100">{{ ucfirst(str_replace('_', ' ', $assetMovement->status_pergerakan)) }}</span>
                        </div>
                        <div class="flex items-center space-x-2">
                            <i class='bx bx-calendar text-emerald-200'></i>
                            <span
                                class="text-emerald-100">{{ $assetMovement->tarikh_pergerakan ? $assetMovement->tarikh_pergerakan->format('d/m/Y') : 'Belum ditetapkan' }}</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl p-6 border border-amber-200">
                <div class="flex items-center justify-between">
                    ...
                    <div
                        class="w-12 h-12 bg-{{ $assetMovement->status_pergerakan === 'diluluskan' ? 'green' : ($assetMovement->status_pergerakan === 'menunggu_kelulusan' ? 'amber' : 'red') }}-500 rounded-xl flex items-center justify-center">
                        <i
                            class='bx bx-{{ $assetMovement->status_pergerakan === 'diluluskan' ? 'check' : ($assetMovement->status_pergerakan === 'menunggu_kelulusan' ? 'time' : 'x') }} text-white text-xl'></i>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-900">
                            {{ $assetMovement->tarikh_pergerakan ? $assetMovement->tarikh_pergerakan->format('d/m') : '-' }}
                        </p>
                        <p class="text-xs text-green-600 mt-1">
                            {{ $assetMovement->tarikh_pergerakan ? $assetMovement->tarikh_pergerakan->format('Y') : 'Belum ditetapkan' }}
                        </p>
                    </div>
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-6 border border-emerald-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            <div class="flex items-center mb-2">
                                <i class='bx bx-abacus text-emerald-600 mr-2'></i>
                                <dt class="text-sm font-medium text-gray-600">Kuantiti</dt>
                            </div>
                            <dd class="text-lg font-semibold text-gray-900">{{ $assetMovement->kuantiti ?? 1 }}</dd>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="flex items-center">
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $assetMovement->status_pergerakan === 'diluluskan' ? 'bg-green-100 text-green-800' : ($assetMovement->status_pergerakan === 'menunggu_kelulusan' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800') }}">
                                    <div
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $assetMovement->tarikh_permohonan ? $assetMovement->tarikh_permohonan->format('d/m/Y') : '-' }}
                            </dd>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">
                                {{ $assetMovement->tarikh_pergerakan ? $assetMovement->tarikh_pergerakan->format('d/m/Y') : '-' }}
                            </dd>
                        </div>

                        @if($assetMovement->tarikh_jangka_pulang)
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">{{ $assetMovement->lokasi_asal_spesifik }}</dd>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <dd class="text-lg font-semibold text-gray-900">{{ $assetMovement->lokasi_destinasi_spesifik }}
                            </dd>
                        </div>
                    </div>
                </div>
                ...
                @if($assetMovement->sebab_pergerakan || $assetMovement->catatan_pergerakan || $assetMovement->sebab_penolakan)
                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            @if($assetMovement->tujuan_pergerakan)
                                <!-- Purpose -->
                                <div class="bg-white rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center mb-2">
                                    ...
                                    <dd class="text-gray-900">{{ $assetMovement->tujuan_pergerakan }}</dd>
                                </div>
                            @endif

                            @if($assetMovement->pembekal)
                                <!-- Pembekal -->
                                <div class="bg-white rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center mb-2">
                                    ...
                                    <dd class="text-gray-900">{{ $assetMovement->pembekal }}</dd>
                                </div>
                            @endif

                            @if($assetMovement->catatan)
                                <!-- Notes -->
                                <div class="bg-white rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center mb-2">
                                        <i class='bx bx-note text-blue-600 mr-2'></i>
                                        <dt class="text-sm font-medium text-gray-600">Catatan/Sebab Penolakan</dt>
                                    </div>
                                    <dd class="text-gray-900">{{ $assetMovement->catatan }}</dd>
                                </div>
                            @endif
                ...
                @if($assetMovement->diluluskan_oleh || $assetMovement->tarikh_kelulusan)
                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            @if($assetMovement->pegawai_meluluskan)
                                <!-- Approved By -->
                                <div class="bg-white rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center mb-2">
                                    ...
                                    <dd class="text-lg font-semibold text-gray-900">{{ $assetMovement->pegawai_meluluskan }}</dd>
                            ...
                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                ...
                                <dd class="flex items-center">
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $assetMovement->status_pergerakan === 'diluluskan' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                        <div
                                            class="w-2 h-2 {{ $assetMovement->status_pergerakan === 'diluluskan' ? 'bg-green-500' : 'bg-red-500' }} rounded-full mr-2">
                                        </div>
                    ...
                    <div class="bg-white rounded-xl p-6 border border-gray-200">
                        ...
                        <div class="space-y-3">
                            @if($assetMovement->status_pergerakan === 'menunggu_kelulusan')
                                ...
                                <form action="{{ route('admin.asset-movements.approve', $assetMovement) }}" method="POST"
                                    class="w-full">
                                    @csrf
                                    @method('PATCH')
                                    <button type="submit"
                    ...
                    <div class="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-6 border border-green-200">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span
                                    class="font-semibold text-green-700">{{ $assetMovement->created_at->format('d/m/Y') }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600">Kemaskini Terakhir:</span>
                                <span
                                    class="font-semibold text-green-700">{{ $assetMovement->updated_at->format('d/m/Y') }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600">Nilai Aset:</span>
                                <span class="font-semibold text-green-700">RM
                                    {{ number_format($assetMovement->asset->nilai_perolehan ?? 0, 0) }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600">Umur Permohonan:</span>
                                <span
                                    class="font-semibold text-green-700">{{ $assetMovement->created_at->diffForHumans() }}</span>
                            </div>
                        </div>
                    </div>
        ...
        <div id="rejectModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 hidden">
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <form action="{{ route('admin.asset-movements.reject', $assetMovement) }}" method="POST"
