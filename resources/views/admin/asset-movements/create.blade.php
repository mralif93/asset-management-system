                                ...
                                <div class="relative">
                                    <select id="masjid_surau_asal_id" 
                                        ...
                                        @foreach($masjidSuraus as $masjid)
                                            <option value="{{ $masjid->id }}" {{ old('masjid_surau_asal_id') == $masjid->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select id="masjid_surau_destinasi_id" 
                                        ...
                                        @foreach($masjidSuraus as $masjid)
                                            <option value="{{ $masjid->id }}" {{ old('masjid_surau_destinasi_id') == $masjid->id ? 'selected' : '' }}>
                                                {{ $masjid->nama }} ({{ $masjid->jenis }})
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" 
                                           ...
                                           value="{{ old('lokasi_terperinci_asal') }}"
                                           required
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" 
                                           ...
                                           value="{{ old('lokasi_terperinci_destinasi') }}"
                                           required
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="space-y-2">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-sm font-medium" x-text="form.lokasi_terperinci_asal || '-'">-</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-600">Ke:</span>
                                        <span class="text-sm font-medium" x-text="form.lokasi_terperinci_destinasi || '-'">-</span>
                                    </div>
    ...
    function createMovementForm() {
        return {
            form: {
                ...
                masjid_surau_asal_id: '{{ old('masjid_surau_asal_id') }}',
                masjid_surau_destinasi_id: '{{ old('masjid_surau_destinasi_id') }}',
                lokasi_terperinci_asal: '{{ old('lokasi_terperinci_asal') }}',
                lokasi_terperinci_destinasi: '{{ old('lokasi_terperinci_destinasi') }}',
            ...
            updateAssetInfo() {
                if (this.form.asset_id) {
                    ...
                    if (selectedAsset) {
                        ...
                        this.form.lokasi_terperinci_asal = selectedAsset.lokasi_penempatan || '';
                    }
                } else {
                    this.assetInfo = {
                        current_location: '',
