                                ...
                                <button @click="open = !open"
                                    ...
                                    <div class="hidden md:block text-left">
                                        ...
                                        <p class="text-xs text-gray-500">
                                            ...
                                            • {{ Auth::user()->position ?? ucfirst(Auth::user()->role) }}</p>
                                    </div>
            ...
            <div class="flex-1 overflow-y-auto bg-gray-50">
                <div class="min-h-full flex flex-col">
                    ...
                    <div class="flex-1 p-8">
                        ...
                        @if (session('success'))
                            <div
                                class="mb-6 bg-emerald-50 border-l-4 border-emerald-400 text-emerald-700 px-6 py-4 rounded-r-xl shadow-sm">
                        ...
                        @if (session('error'))
                            <div
                                class="mb-6 bg-red-50 border-l-4 border-red-400 text-red-700 px-6 py-4 rounded-r-xl shadow-sm">
                                <div class="flex items-center">
