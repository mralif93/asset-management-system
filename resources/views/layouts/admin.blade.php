...
<body class="bg-gray-50 text-gray-900 font-sans">
    <div class="flex h-screen overflow-hidden">
        ...
        <!-- Sidebar -->
        <aside
            class="fixed inset-y-0 left-0 z-40 w-72 bg-gradient-to-b from-emerald-700 via-emerald-600 to-emerald-800 shadow-2xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 flex flex-col"
            ...
            <div class="p-8 border-b border-emerald-500/30 flex-shrink-0">
                <div class="flex items-center space-x-4">
                    <div
                        class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-lg hover:rotate-12 transition-transform duration-300">
            ...
            <!-- Navigation -->
            <nav
                class="flex-1 overflow-y-auto p-6 space-y-2 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
                <!-- Dashboard Section -->
                <div class="mb-8">
                    <h3
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <!-- Notifications -->
                            <button
                                class="relative p-2 text-gray-400 hover:text-gray-600 focus:outline-none focus:text-gray-600 transition-colors duration-150">
            ...
            <div class="flex-1 overflow-y-auto bg-gray-50">
                <div class="min-h-full flex flex-col">
                    ...
                    <div class="flex-1 p-8">
                        ...
                        @if (session('success'))
                            <div
                                class="mb-6 bg-emerald-50 border-l-4 border-emerald-400 text-emerald-700 px-6 py-4 rounded-r-xl shadow-sm animate-pulse">
                        ...
                        @if (session('error'))
                            <div
                                class="mb-6 bg-red-50 border-l-4 border-red-400 text-red-700 px-6 py-4 rounded-r-xl shadow-sm animate-pulse">
                                <div class="flex items-center">
