    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span
                        class="text-sm text-blue-600 bg-blue-100 px-2 py-1 rounded-full font-medium">{{ ucfirst(Auth::user()->role) }}</span>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <a href="{{ route('user.asset-requests.index') }}"
                ...
                <h3 class="font-semibold text-gray-900 mb-2">Permohonan Aset</h3>
                <p class="text-sm text-gray-600">Semak status pemindahan pinjaman aset</p>
            </a>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl border border-gray-200">
                    ...
                    <div class="p-6">
                        <div class="space-y-3">
                            <a href="{{ route('user.profile.edit') }}"
                                class="flex items-center space-x-3 text-sm text-gray-700 hover:text-emerald-600 transition-colors">
