...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Create Account - AssetFlow</title>
        ...
        <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-md w-full space-y-8">
                ...
                <div class="text-center">
                    ...
                    <h2 class="text-3xl font-display font-bold text-slate-900 mb-2">Create your account</h2>
                    <p class="text-slate-600">Join thousands of companies using AssetFlow</p>
                </div>
                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-6">
                            ...
                            <div class="flex items-start">
                                ...
                                <label for="terms" class="ml-2 block text-sm text-slate-600">
                                    I agree to the <a href="#" class="text-emerald-600 hover:text-emerald-500 font-medium">Terms of Service</a> and <a href="#" class="text-emerald-600 hover:text-emerald-500 font-medium">Privacy Policy</a>
                                </label>
                            </div>
                ...
                <!-- Features Preview -->
                <div class="text-center">
                    <p class="text-sm text-slate-500 mb-4">Join 3,000+ companies worldwide</p>
