        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-3xl font-bold text-white mb-2">Mulakan Perjalanan Anda</h2>
                    <p class="text-slate-300">Cipta akaun AssetFlow anda sekarang</p>
                ...
                <!-- Register Form -->
                <form method="POST" action="{{ route('register.submit') }}" class="space-y-6" x-data="{ showPassword: false, showPasswordConfirmation: false }">
                    @csrf
                    ...
                    <!-- Position Field -->
                    <div>
                        <label for="position" class="block text-sm font-medium text-slate-200 mb-2">
                            <svg class="w-4 h-4 inline mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <input id="position" 
                               ...
                               required 
                               class="block w-full px-4 py-3 rounded-xl border border-white/20 bg-white/10 backdrop-blur-sm text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200"
                               placeholder="Contoh: Pegawai Pentadbiran">
                        @error('position')
                            <p class="mt-2 text-sm text-red-300 flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                    ...
                    <div>
                        <label for="masjid_surau_id" class="block text-sm font-medium text-slate-200 mb-2">
                            <svg class="w-4 h-4 inline mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                            Masjid/Surau
                        ...
                        <select id="masjid_surau_id" 
                                ...
                                required 
                                class="block w-full px-4 py-3 rounded-xl border border-white/20 bg-white/10 backdrop-blur-sm text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200">
                            <option value="" class="text-slate-800">Pilih Masjid/Surau</option>
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                <div class="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                    ...
                    <h3 class="text-sm font-medium text-white mb-1">Setup Pantas</h3>
                    <p class="text-xs text-slate-400">Siap dalam 2 minit</p>
                </div>
                ...
                <div class="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                    ...
                    <h3 class="text-sm font-medium text-white mb-1">Percuma Selamanya</h3>
                    <p class="text-xs text-slate-400">Tiada bayaran tersembunyi</p>
                </div>
                ...
                <div class="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                    ...
                    <p class="text-xs text-slate-400">Bantuan bila-bila masa</p>
                </div>
            </div>
